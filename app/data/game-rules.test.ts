...
import { bestLineProgress, findDuplicateWords, makeCard, normalizeWords, requiredWords, validateClaim, winningLines } from './game-rules.ts'
...
describe('bingo rules', () => {
  ...
  it('creates a 6×6 card without a free center', () => {
    const card = makeCard(Array.from({ length: 50 }, (_, index) => index + 1), 6)
